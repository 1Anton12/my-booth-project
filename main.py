...
CONFIGURATOR_URL = os.getenv("CONFIGURATOR_URL", "http://127.0.0.1:8000/booth_configurator.html")
# Для локального теста запустите веб-сервер в папке проекта, например:
# python -m http.server 8000
# Затем бот будет открывать локальную страницу вместо удаленной.
